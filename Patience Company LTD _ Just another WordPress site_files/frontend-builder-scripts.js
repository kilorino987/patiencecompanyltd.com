		...
		$(document).ready( function(){
			...
			$( window ).ready( function(){
				if ( $.fn.fitVids ) {
					...
					$( '.et_pb_module' ).fitVids( { customSelector: "iframe[src^='http://web.archive.org/web/20181202173746/http://www.hulu.com'], iframe[src^='http://web.archive.org/web/20181202173746/http://www.dailymotion.com'], iframe[src^='http://web.archive.org/web/20181202173746/http://www.funnyordie.com'], iframe[src^='http://web.archive.org/web/20181202173746/https://embed-ssl.ted.com'], iframe[src^='http://web.archive.org/web/20181202173746/http://embed.revision3.com'], iframe[src^='http://web.archive.org/web/20181202173746/https://flickr.com'], iframe[src^='http://web.archive.org/web/20181202173746/http://blip.tv'], iframe[src^='http://web.archive.org/web/20181202173746/http://www.collegehumor.com']"} );
				}
...
/*
     FILE ARCHIVED ON 17:37:46 Dec 02, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:26:33 Jun 03, 2022.
...
/*
playback timings (ms):
  captures_list: 118.643
  exclusion.robots: 0.246
  exclusion.robots.policy: 0.226
  RedisCDXSource: 0.861
  esindex: 0.014
  LoadShardBlock: 89.635 (3)
  PetaboxLoader3.resolve: 3472.731 (3)
  PetaboxLoader3.datanode: 44.489 (4)
  CDXLines.iter: 23.974 (3)
  load_resource: 3453.723
*/