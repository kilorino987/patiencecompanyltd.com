...
(function($){
	...
	$(document).ready( function(){
		...
		$( window ).ready( function(){
			if ( $.fn.fitVids ) {
				$( '#main-content' ).fitVids( { customSelector: "iframe[src^='http://web.archive.org/web/20181202175823/http://www.hulu.com'], iframe[src^='http://web.archive.org/web/20181202175823/http://www.dailymotion.com'], iframe[src^='http://web.archive.org/web/20181202175823/http://www.funnyordie.com'], iframe[src^='http://web.archive.org/web/20181202175823/https://embed-ssl.ted.com'], iframe[src^='http://web.archive.org/web/20181202175823/http://embed.revision3.com'], iframe[src^='http://web.archive.org/web/20181202175823/https://flickr.com'], iframe[src^='http://web.archive.org/web/20181202175823/http://blip.tv'], iframe[src^='http://web.archive.org/web/20181202175823/http://www.collegehumor.com']"} );
			}
		} );
...
/*
     FILE ARCHIVED ON 17:58:23 Dec 02, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:26:24 Jun 03, 2022.
...
/*
playback timings (ms):
  captures_list: 91.483
  exclusion.robots: 0.117
  exclusion.robots.policy: 0.109
  RedisCDXSource: 0.808
  esindex: 0.008
  LoadShardBlock: 66.577 (3)
  PetaboxLoader3.datanode: 72.587 (4)
  CDXLines.iter: 20.983 (3)
  load_resource: 131.329
  PetaboxLoader3.resolve: 101.191
*/